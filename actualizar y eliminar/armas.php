<?php
    ...
    $imagenes= $_POST['imagenes'];
            ...
            $insert= $con -> prepare ("UPDATE id_armas SET nombre='$nombre', tipo='$tipo' , cant_balas='$cant_balas', dano='$dano', imagenes='$imagenes'  WHERE id_armas = '".$_GET['id']."'");
            $insert -> execute();
...
<body onload="centrar();">
        ...
        <table class="center">
            <form autocomplete="off" name="form_actualizar" method="POST">
                ...
                <tr>
                    <td>imagenes</td>
                    <td><input type="" name="imagenes" value="<?php echo $fila['imagenes'] ?>"></td>                 
                </tr>
